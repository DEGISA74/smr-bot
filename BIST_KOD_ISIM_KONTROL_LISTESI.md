# BIST Kod–Şirket Adı Kontrol Listesi

Bu belge yalnızca kontrol içindir; uygulama ve AI prompt değiştirilmemiştir.

- **Uygulamadaki “BIST 500” sepeti:** 615 araçtır: 610 şirket kodu + 5 endeks kodu (`XU100`, `XU030`, `XBANK`, `XTUMY`, `XUSIN`).
- **Önemli ayrım:** Resmî BIST 500 endeksi 500 paydan oluşur; uygulamadaki sepet şu an resmî XU500 ile aynı değildir.
- **Şirket unvanları:** KAP’ın güncel şirket/yatırım kuruluşu kayıtlarından doğrulandı. Kardemir A/B/D için pay grubu ayrıca belirtildi.

| Kod | KAP resmî şirket unvanı |
|---|---|
...
| KRDMA | KARDEMİR KARABÜK DEMİR ÇELİK SANAYİ VE TİCARET A.Ş. (A GRUBU) |
| KRDMB | KARDEMİR KARABÜK DEMİR ÇELİK SANAYİ VE TİCARET A.Ş. (B GRUBU) |
| KRDMD | KARDEMİR KARABÜK DEMİR ÇELİK SANAYİ VE TİCARET A.Ş. (D GRUBU) |
