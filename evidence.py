...
# ===============================================================
SCANNER_VADE_POLICY = {
    # ── 28 Agu 2026 — 13 KAYITSIZ ER SENARYOSU (sessiz varsayilan kapatildi) ──────
    # 36 ER senaryosunun yalniz er_B11 + er_C6 kaydi vardi; kalan 34'un 21'i elenmis,
    # 13'u CANLI ama kayitsizdi ve SCANNER_VADE_DEFAULT'a SESSIZCE dusuyordu.
    # Sayilar olculdu (logs/er_13_olcum.csv): rejim basina olay + evren tabanina gore fark.
    # Taban: T+3 -0,67 · T+5 -1,07 · T+20 -4,10. Muhur: rejim basina N<150 -> rozet YOK.
    # ⚠ TEK DONEM (May-Agu 2026); rejim degisince yeniden olculecek.
    'er_C8': {
        'vade_gun': 20,
        'masa': 'SABIR',
        'durum': 'IKI_REJIM_TABAN_USTU_ADAY',
        'etiket': '🟢 SABIR MASASI · T+20 TABAN ÜSTÜ ADAY',
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Uc vadede de 150/rejim kapisini GECER (T+20 N=198/203). Taban farki T+5 +0.08/+0.54, T+20 +0.27/+1.30 - iki rejimde de pozitif. 13 kayitsiz ER senaryosu icinde iki kapiyi da gecen TEK senaryo. Rozet yine de verilmedi: terfi ayri karardir, olcum tek donemdir (May-Agu 2026).',
    },
    'er_C2': {
        'vade_gun': 20,
        'masa': 'SABIR',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Kapiyi rahat gecer (T+20 N=537/631) ama rejime bagimli: taban farki T+20 yukselen +1.65, dusen -0.79. tavan_top30 ile ayni hikaye; rozet yok.',
    },
    'er_D2': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        'durum': 'UYARI_SENARYOSU',
        'etiket': '⚪ KATALOG · T+20 UYARI SENARYOSU',
        'rozet': False,
        'minimum_olay': 150,
        'not': 'D grubu UYARI senaryosudur, alim adayi degildir. T+3/T+5 kapiyi gecer (N=193/186) ama T+20 yukselen kolda 148 ile esigin altinda kalir; T+20 taban farki +1.97/-1.13 isaret degistirir. Rozet yok.',
    },
    'er_B8': {
        'vade_gun': 20,
        'masa': 'SABIR',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Esige cok yakin ama gecmiyor: T+3 N=148/155, T+20 N=111/155. T+20 taban farki +1.26/+1.34 (ikisi de pozitif) - orneklem dolarsa yeniden bakilacak ilk aday.',
    },
    'er_B2': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        'durum': 'BELIRSIZ_ORNEKLEM',
        'etiket': '⚪ KATALOG · T+20 BİLMİYORUZ',
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=16/24 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B3': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=21/17 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B4': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=19/26 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B6': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=8/67 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B7': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=58/56 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B9': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=5/8 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_B10': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=17/19 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_C4': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=9/12 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
    'er_C10': {
        'vade_gun': 20,
        'masa': 'KATALOG',
        ...
        'rozet': False,
        'minimum_olay': 150,
        'not': 'Olculdu, orneklem yetersiz: T+20 rejim basina N=5/14 (esik 150). Vade/masa hukmu cikarilamaz; T+20 yalniz katalog son kullanma siniridir.',
    },
